...
const Navoste = () => {
  return (
   <section className='relative overflow-hidden'> 
      ...
      <Image src={"/images/bludaimg_chap.png"} alt="leaf" width={220} height={220} className="absolute bottom-[20%] -left-10 rotate-[15deg] opacity-85 z-0 pointer-events-none blur-[2px]" />
      <Image src={"/images/bludaimg_ong.png"} alt="leaf" width={150} height={150} className="absolute bottom-[5%] right-10 rotate-[-15deg] opacity-60 z-0 pointer-events-none" />
        ...
        <div>
           <h2 className="text-center text-[48px] font-extrabold mb-35.75">Галерея</h2>
              <div>
                   <ul className=" grid grid-cols-4  gap-y-35 gap-x-10 gap-3.5 justify-items-center mx-auto w-full gap-27.5">
